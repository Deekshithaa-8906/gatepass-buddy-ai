...
import { LogIn, GraduationCap, ArrowLeft, Mail } from 'lucide-react';
      ...
      <main className="relative z-10 flex-grow flex items-center justify-center p-6 sm:p-12">
        <div className="max-w-md w-full bg-white/20 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 text-center flex flex-col items-center relative overflow-hidden transition-all duration-300 m-[2px] p-8 sm:p-10">
          ...
          <form className="w-full space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button type="submit" className="w-full flex items-center justify-center gap-2 bg-[#CD0000] hover:bg-[#a80000] text-white rounded-xl font-bold transition-all shadow-md hover:shadow-lg active:scale-95 text-center px-6 py-3.5 mt-4">
              Verify Email
            </button>
          </form>
