...
export function HodForm() {
  ...
  const { register, handleSubmit, watch, formState: { errors } } = useForm<HodFormData>({
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-1.5 md:col-span-2">
          ...
          <div className="relative">
            ...
            <input type="text" readOnly value="Head of Department (HOD)" 
        ...
        <div className="space-y-1.5 md:col-span-2">
          ...
          <div className="mt-2 flex gap-2 items-start p-3 bg-blue-50 border border-blue-100 rounded-lg">
            <Info className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
            <p className="text-xs text-blue-800 font-medium leading-relaxed">
              Note: Only one HOD can be assigned per department in a campus. Ensure you select the correct department.
            </p>
          </div>
        </div>
